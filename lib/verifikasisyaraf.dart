...
class VerifikasiSyaraf extends StatefulWidget {
  static bool jenis = false;
  static String poli = "";
  static String id = "";
  const VerifikasiSyaraf({Key? key}) : super(key: key);

  @override
  _DaftarState createState() => _DaftarState();
}

class _DaftarState extends State<VerifikasiSyaraf> {
  TextEditingController hp = TextEditingController();
  TextEditingController tgl = TextEditingController();
  String no = "";
  String tanggal = "";
  CollectionReference verifsyaraf =
